/****************************************************************************
** Meta object code from reading C++ file 'movingrect.h'
**
...
#include <memory>
#include "../../../Cart/movingrect.h"
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'movingrect.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_MovingRect_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_MovingRect_t qt_meta_stringdata_MovingRect = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_MovingRect[] = {
...
Q_CONSTINIT const QMetaObject MovingRect::staticMetaObject = { {
    QMetaObject::SuperData::link<QGraphicsObject::staticMetaObject>(),
    qt_meta_stringdata_MovingRect.offsetsAndSizes,
