...
#include <memory>
#include "../../../../../LabWork_7/HashTable/Task3/tableview.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_TableView_t, stringdata0) + ofs), len 
...
const QMetaObject TableView::staticMetaObject = { {
    ...
    qt_meta_stringdata_TableView.offsetsAndSize,
...
void *TableView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "HashTable<QString>"))
        return static_cast< HashTable<QString>*>(this);
